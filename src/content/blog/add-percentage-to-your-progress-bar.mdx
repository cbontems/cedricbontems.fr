...
summary: The article introduces the Scroll-Driven Animations API, which enables the creation of smooth, scroll-responsive animations on the web. This new API, supported in Chrome 115, integrates with existing animation APIs and offers Scroll Timelines and View Timelines, allowing developers to link animations to scroll position and element visibility. It provides precise control over animation ranges, enhancing the user experience through synchronized, high-performance scroll-driven animations.
tldr:
  - The Scroll-Driven Animations API empowers developers to create scroll-responsive animations on websites.
  - It integrates with existing animation APIs, offering Scroll Timelines and View Timelines for animation synchronization with scrolling and element visibility.
  - This API provides precise control over animation ranges, enhancing user experiences through high-performance, scroll-driven animations.
  - Currently supported from Chrome / Edge 115, Opera 101, the API promises to bring smoother, more interactive web animations to the forefront of web development.
authors:
  - cedric
category: css
tags:
...
In a previous post, we saw how to create a [scroll-driven progress bar](/blog/100-percent-css-scroll-driven-progress-bar/) using the CSS Scroll-Driven Animations API. In this post, we will see how to add the current percentage to the bar.
...
>
	<span>
		See the Pen{" "}
		<a href="https://codepen.io/cbontems/pen/xxmBYwv">
